package com.lion2.lion2.controller;

import com.lion2.lion2.dto.board.BoardResponseDTO;
import com.lion2.lion2.dto.board.BoardWriteRequestDTO;
import com.lion2.lion2.dto.comment.CommentResponseDTO;
import com.lion2.lion2.dto.image.BoardImageUploadDTO;
import com.lion2.lion2.service.board.BoardService;
import com.lion2.lion2.service.comment.CommentService;
...
//     */
    ...
    public String boardUpdateForm(@PathVariable Long id, Model model, Authentication authentication) {
        UserDetails userDetails = (UserDetails) authentication.getPrincipal();
        BoardResponseDTO result = boardService.boardDetail(id);
        if (result.getPhone() != userDetails.getUsername()) {
            return "redirect:/";
        }
...
//     */
    ...
    public String boardRemove(@PathVariable Long id, Authentication authentication) {
        UserDetails userDetails = (UserDetails) authentication.getPrincipal();
        BoardResponseDTO result = boardService.boardDetail(id);
        if (!Objects.equals(result.getPhone(), userDetails.getUsername())) {
            return "redirect:/";
        }
